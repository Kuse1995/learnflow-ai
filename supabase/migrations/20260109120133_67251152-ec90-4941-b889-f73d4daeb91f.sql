-- Fix the archive_school_cascade function to use valid enum value
...
BEGIN
  ...
  -- 6. Soft-delete guardian-student links
  ...
  -- 7. Suspend the school subscription (using 'suspended' instead of 'cancelled')
